...
#define ING_INSTANTIATE_HASH_TABLE_TEMPLATE(element_type)                                                               \
    ...
    static inline bool ing_hash_table_##element_type##_contains(ing_hash_table(element_type)* hash_table, element_type value) {             \
        ...
        size_t bucket_index = hash % ing_dynamic_array_size(ING_PRIVATE_ptr_to_linked_list_##element_type, &hash_table->PRIVATE.arr);          \
                                                                                                                        \
        ing_linked_list(element_type)* node = ing_dynamic_array_at(ING_PRIVATE_ptr_to_linked_list_##element_type, &hash_table->PRIVATE.arr, bucket_index);          \
        while(node) {                                                                                                   \
...
#define ING_INSTANTIATE_HASH_TABLE_TEMPLATE_AND_DEPENDENCY_TEMPLATES(element_type) \
    ...
    typedef ING_PRIVATE_linked_list_##element_type* ING_PRIVATE_ptr_to_linked_list_##element_type;        \
    ING_INSTANTIATE_DYNAMIC_ARRAY_TEMPLATE(ING_PRIVATE_ptr_to_linked_list_##element_type)         \
                                                                                   \
